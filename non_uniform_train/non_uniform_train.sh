...
CUDA_VISIBLE_DEVICES=$GPU_DEVICE python -u $CODE_PATH/run.py --do_valid --cuda -init $SAVE --triplet_type $TRIPLET_TYPE --overall_data_path $FULL_DATA_PATH --negative_sample_type_test $negative_sample_type_test
...
CUDA_VISIBLE_DEVICES=$GPU_DEVICE python -u $CODE_PATH/run.py --do_test --cuda -init $SAVE --data_path $TEST_DATA_PATH  --triplet_type $TRIPLET_TYPE --overall_data_path $FULL_DATA_PATH --negative_sample_type_test $negative_sample_type_test
